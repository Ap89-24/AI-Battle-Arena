...
export default function Sidebar({ isOpen, onClose, battleData, history, onSelectBattle }) {
  ...
  const handleExportMarkdown = () => {
    ...
    battleData.turns.forEach((turn, idx) => {
      ...
      md += `### Solution 1 (Mistral) — Score: ${turn.judge.solution_1_score}/10\n${turn.solution_1}\n\n`;
      md += `### Solution 2 (Cohere) — Score: ${turn.judge.solution_2_score}/10\n${turn.solution_2}\n\n`;
      md += `### Judge Verdict\n**Winner: ${winner}**\n\n`;
      md += `#### Mistral Reasoning:\n${turn.judge.solution_1_reasoning}\n\n`;
              ...
              >
                {history.map((item, i) => (
                  ...
                  >
                    ...
                    >
                      {item.turns?.[0]?.problem ?? "Empty Battle"}
                    </div>
                    <div
                      style={{
                        fontFamily: "JetBrains Mono, monospace",
