    ...
    <div style={{
      ...
      <div className={`fade-slide-up ${mounted ? 'visible' : ''}`} style={{ animationDelay: '0.2s', textAlign: 'center', marginBottom: '1.5rem' }}>
        <h1 style={{
          ...
          <span style={{
            background: 'linear-gradient(135deg, #dfe1f6 0%, #bacac5 40%, #dfe1f6 100%)',
          ...
          <span style={{
            background: 'linear-gradient(135deg, #2dd4bf 0%, #6366f1 50%, #a855f7 100%)',
            WebkitBackgroundClip: 'text',
            WebkitTextFillColor: 'transparent',
            backgroundClip: 'text',
          }}>
      ...
      {/* Subtitle */}
      <div className={`fade-slide-up ${mounted ? 'visible' : ''}`} style={{ animationDelay: '0.35s', marginBottom: '3rem' }}>
        <p style={{
          fontFamily: 'Space Grotesk, sans-serif',
      ...
      {/* Input */}
      <div className={`fade-slide-up ${mounted ? 'visible' : ''}`} style={{ animationDelay: '0.5s', width: '100%', maxWidth: '760px' }}>
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ textAlign: 'right', marginTop: '8px', paddingRight: '4px' }}>
            <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '11px', color: '#859490' }}>
              Press{' '}
              <kbd style={{
